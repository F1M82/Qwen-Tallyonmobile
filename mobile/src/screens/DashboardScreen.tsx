...
import { reportAPI, complianceAPI, connectorAPI } from '../services/api';
  ...
  const quickActions = [
    {
      ...
      title: 'Voice Entry',
      screen: 'VoiceEntry' as const,
      color: '#3B82F6',
    },
    {
      icon: 'camera-outline' as const,
      title: 'Scan Invoice',
      screen: 'InvoiceScan' as const,
      color: '#10B981',
    },
    {
      icon: 'swap-horizontal-outline' as const,
      title: 'Reconcile',
      screen: 'Reconciliation' as const,
      color: '#F59E0B',
    },
    {
      icon: 'chatbubble-outline' as const,
      title: 'Ask TaxMind',
      screen: 'TaxMindChat' as const,
      color: '#8B5CF6',
    },
  ];
        ...
        <View style={styles.summaryCards}>
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>
              ₹{reports?.data?.assets?.toLocaleString() || '0'}
            </Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Total Liabilities</Text>
            <Text style={styles.summaryValue}>
              ₹{reports?.data?.liabilities?.toLocaleString() || '0'}
            </Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Outstanding</Text>
            <Text style={styles.summaryValue}>
              ₹{reports?.data?.outstanding?.toLocaleString() || '0'}
            </Text>
          </View>
        </View>
      </View>
